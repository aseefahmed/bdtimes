...
@section('content')
    <div ng-controller="MainController">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">ক্রিকেট</h3>
                        </div>
                        <div class="big-section-slider">
                            <?php
                            $i=0;
                            ?>
                            @foreach($cric_news as $index=>$news)
                                @if($i<3)
                                    <?php $i++; ?>
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">ফুটবল</h3>
                        </div>
                        <div class="big-section-slider">
                            <?php
                            $i=0;
                            ?>
                            @foreach($football_news as $index=>$news)
                                @if($i<3)
                                    <?php $i++; ?>
                                    <div class="single-big-slider"  style="background-image: url({{ url('public/images/news/featured/'.$news->featured_image) }})">
                                        <a href="{{ url('news/front/details/'.$news->id) }}" class="slider-headline">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">অন্যান্য</h3>
                        </div>
                        <div class="big-section-slider">
                            <?php
                            $i=0;
                            ?>
                            @foreach($other_news as $index=>$news)
                                @if( $i<3)
                                    <?php $i++; ?>
                                    <div class="single-big-slider"  style="background-image: url({{ url('public/images/news/featured/'.$news->featured_image) }})">
                                        <a href="{{ url('news/front/details/'.$news->id) }}" class="slider-headline">
        ...
        <br>
        <div class="container">
            <a href="{{url('category/sports/more')}}" class="news-readmore-btn btn btn-primary">আরও খবর</a>
        </div>
        <br>
