...
@section('content')
    <div ng-controller="MainController">
                            ...
                            <div class="col-sm-7">
                                <div class="breakingnews-carousel">
                                    ...
                                    @else
                                        ...
                                        <div class="single-breakingnews-item">
                                            <div class="breakingnews-bg"  style="background-image: url(http://www.utd111.co.uk/blog/wp-content/uploads/2015/01/nonewscomp.jpg)">
                                            </div>
                                        </div>
                                    @endif
        ...
        <br>
        <div class="container">
            <a href="{{url('category/legal-aids/more')}}" class="news-readmore-btn btn btn-primary">আরও খবর</a>
        </div>
        <br>
