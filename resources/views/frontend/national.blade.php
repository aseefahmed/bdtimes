    ...
    <div ng-controller="MainController">
                    ...
                    <div class="col-md-12">
                        <div class="double-ad" id="sticker">
                            ...
                            <div class="single-long-ad-right">
                                ...
                                @if(isset(Auth::user()->id))
                                    @if(Auth::user()->role ==1)
                                    <img ng-click="changeAd('National', 12)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[1]->image_id)}}" alt="">
                                    @else
        ...
        <div class="section-padding breaking-news-slider padding-top-zero">
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="aside-advertise-3 scrollToShow">
                        <div class="ad">
                            @if(isset(Auth::user()->id))
                                @if(Auth::user()->role ==1))
                                <img ng-click="changeAd('National', 12)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[2]->image_id)}}" alt="">
                                @else
                ...
                <div class="container">
                    @if(count($national_breaking_news)>0)
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="cta-bar">
                                    <h2>টপ নিউজ</h2>
                        ...
                        @if(isset($all_news[0]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[0]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[1]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[1]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[5]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[5]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[6]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[6]->details), 0, 290); ?></p>
                                    <a href="{{ url('news/front/details/'.$all_news[6]->id) }}" class="news-readmore-btn">বিস্তারিত<i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        @else
                            <div class="single-thumbnail-item-1">
                                <div class="thumbnail-bg single-thumbnail-1" style="background-image: url(http://www.utd111.co.uk/blog/wp-content/uploads/2015/01/nonewscomp.jpg)"></div>
                                <div class="news-content">
                                    </a>
                                </div>
                            </div>
                        ...
                        @if(isset($all_news[7]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[7]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[8]))
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[8]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[9]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[9]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[10]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[10]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[11]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[11]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[12]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[12]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[13]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[13]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[14]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[14]->details), 0, 290); ?></p>
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="cta-bar">
                            <h2><a href="{{url('category/ancolik')}}">আঞ্চলিক সংবাদ</a></h2>
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading"><a href="{{url('category/ancolik')}}">আঞ্চলিক সংবাদ</a></h3>
                        </div>
                        <div class="big-section-slider">
                            <?php
                            $i=0;
                            ?>
                            @foreach($ancolik_news as $index=>$news)
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[21]->details), 0, 290); ?></p>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[22]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[26]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[26]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[27]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[27]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[28]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[28]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[29]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[29]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[30]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[30]->details), 0, 290); ?></p>
                        ...
                        @if(isset($all_news[31]))
                            <div class="single-thumbnail-item-3">
                                ...
                                <div class="news-content">
                                    ...
                                    <p><?php echo mb_substr(strip_tags($all_news[31]->details), 0, 290); ?></p>
        ...
        <br>
        <div class="container">
            <a href="{{url('category/national/more')}}" class="news-readmore-btn btn btn-primary">আরও খবর</a>
        </div>
        <br>
        <!--single advertise area-->
        <div class="section-padding advertise-2">
