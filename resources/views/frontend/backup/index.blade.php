...
@section('content')
	...
	<div ng-controller="MainController">
			...
			<div class="container">
				<div class="row">
								...
								<div class="single-thumbnail-item-2">
									...
									<div class="news-content">
										<a href="{{ url('news/front/details/'.$news->id) }}">
											<h3>{{ $news->title }}</h3>
											<p><?php echo mb_substr(strip_tags($news->short_description), 0, strpos($news->short_description, " ", strpos($news->short_description, " ", 120)+1)+1); ?></p>
										</a>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						...
						<?php $i=1;?>
						@foreach($latest_news as $news)
							@if(($news->category_id == 2 || $news->category_id == 24
								|| $news->category_id == 25
								|| $news->category_id == 26
								|| $news->category_id == 28) && $i<3)
								<?php $i++; ?>
								<div class="single-thumbnail-item-2">
									<div class="thumbnail-bg" style="background-image: url(public/images/news/featured/{{$news->featured_image}})"></div>
									<div class="news-content">
										<a href="{{ url('news/front/details/'.$news->id) }}">
											<h3>{{ $news->title }}</h3>
											<p><?php echo mb_substr(strip_tags($news->short_description), 0, strpos($news->short_description, " ", 120)+1); ?></p>
										</a>
										<a href="{{ url('news/front/details/'.$news->id) }}" class="news-readmore-btn"></a>
									</div>
								</div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<h3 class="section-heading"><a href="{{url('category/national')}}">চাকুরি</a></h3>
						<?php $i=1;?>
						@foreach($latest_news as $news)
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 pdt-10">
						<div class="politics">
							<h3 class="section-heading"><a href="{{url('category/national')}}">খেলাধুলা</a></h3>
							<div class="entertainment-carousel">
								@foreach($latest_news as $news)
		...
		<div class="section-padding news-section-im85">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<h3 class="section-heading"><a href="{{url('category/national')}}">রম্য/কার্টুন</a></h3>
						<?php $i=1; ?>
						@foreach($latest_news as $news)
						...
						<div class="col-sm-5 col-sm-offset-2">
							...
							@foreach($apnaar_lekha as $news)
								<div class="single-featured-item">
									...
									<?php echo mb_substr(strip_tags($news->short_description), 0, strpos($news->short_description, " ", 800)+1); ?>
									<a href="{{ url('news/front/details/'.$news->id) }}" class="news-readmore-btn"></a>
								</div>
							@endforeach
						</div>
						...
						@foreach($latest_news as $news)
							@if($news->category_id == 22)
								<div class="single-featured-item-big">
									<h3>{{ $news->title }}</h3>
									<img src="public/images/news/featured/{{$news->featured_image }}" alt="">
									<?php echo mb_substr(strip_tags($news->short_description), 0, strpos($news->short_description, " ", 2500)+1); ?><a href="{{ url('news/front/details/'.$latest_news[40]->id) }}" class="news-readmore-btn"></a></p>
								</div>
								<?php break; ?>
							@endif
		...
		<div class="section-padding news-section-imstrpos($news->short_description, " ", 120)+1">
			<div class="container">
				<div class="row">
					<div class="col-sm-7">
							...
							@foreach($latest_news as $news)
								...
								<div class="single-thumbnail-item-2">
									...
									<div class="news-content">
										<a href="{{ url('news/front/details/'.$news->id) }}">
											<h3>{{$news->title}}</h3>
											<p><?php echo mb_substr(strip_tags($news->short_description), 0, strpos($news->short_description, " ", 720)+1); ?></p>
										</a>
										<a href="{{ url('news/front/details/'.$news->id) }}" class="news-readmore-btn"></a>
									</div>
								</div>
