            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-2">
                    ...
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">জয়ীতা</a></h3>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-2">
                    ...
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">কর্পোরেট</a></h3>
                    </div>
                    <div class="big-section-slider">
                        <div class="single-big-slider big-bg-1">
                            <a href="" class="slider-headline">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-2">
                    ...
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">লাইফ স্টাইল</a></h3>
                    </div>
                    <div class="big-section-slider">
                        <div class="single-big-slider big-bg-1">
                            <a href="" class="slider-headline">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-2">
                    ...
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">গ্লামার ও বিউটি টিপস</a></h3>
                    </div>
                    <div class="video-slides">
                        <div class="single-video-slide">
                            <a href="https://www.youtube.com/watch?v=ctvlUvN6wSE" class="video-play-btn long-height play-bg-1 mfp-iframe">
