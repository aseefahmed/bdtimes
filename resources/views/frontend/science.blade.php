                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">অ্যাপস</h3>
                        </div>
                        <div class="row">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">সাইন্স</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">ই কমার্স</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">আউটসোর্সিং</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
...
<br>
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">চাকরি খুঁজব না দেব</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">সফটওয়্যার প্রশিক্ষণ</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">মোবাইল ইন্সটলমেন</h3>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">সচেতনতা মুলক</h3>
                        </div>
                        <div class="row">
                            @if(count($science_awareness)>0)
                            <div class="col-sm-6 col-xs-12">
        ...
        <br>
        <div class="container">
            <a href="{{url('category/science/more')}}" class="news-readmore-btn btn btn-primary">আরও খবর</a>
        </div>
        <br>
        <!--single advertise area-->
        <div class="section-padding advertise-2">
