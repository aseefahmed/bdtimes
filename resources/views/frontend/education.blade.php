                        ...
                        <div class="double-ad" id="sticker">
                            <div class="single-long-ad-left">
                                ...
                                @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                    <img ng-click="changeAd('Education', 81)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[0]->image_id)}}" alt="">
                                @else
                            ...
                            <div class="single-long-ad-right">
                                ...
                                @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                    <img ng-click="changeAd('Education', 82)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[1]->image_id)}}" alt="">
                                @else
            ...
            <div class="container-fluid">
                <div class="col-md-12">
                    <div class="aside-advertise-3 scrollToShow">
                        <div class="ad">
                            @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                <img ng-click="changeAd('Education', 83)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[2]->image_id)}}" alt="">
                            @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="advertise-1">
                                <a href="">
                                    @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                        <img ng-click="changeAd('Education', 84)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[3]->image_id)}}" alt="">
                                    @else
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-xs-12">
                        ...
                        @if(count($video_news)>2)
                            <div class="video-slides">
                                <div class="single-video-slide">
                                    <a href="{{$video_news[0]->vedio_link}}" style="background-image: url({{ url('public/images/news/featured/'.$video_news[0]->featured_image) }})" class="video-play-btn long-height play-bg-1 mfp-iframe">
                                        <div class="video-icon-table">
                                            <div class="video-icon-tablecell">
                                                <i class="fa fa-play"></i>
                                            </div>
                                        </div>
                                        <a href="{{ url('news/front/details/'.$video_news[0]->id) }}" class="slider-headline">
                                            <h3>{{$video_news[0]->title}}</h3>
                                        </a>
                                    </a>
                                </div>
                                <div class="single-video-slide">
                                    <a href="{{$video_news[1]->vedio_link}}" style="background-image: url({{ url('public/images/news/featured/'.$video_news[1]->featured_image) }})" class="video-play-btn long-height play-bg-2 mfp-iframe">
                                        <div class="video-icon-table">
                                            <div class="video-icon-tablecell">
                                                <i class="fa fa-play"></i>
                                            </div>
                                        </div>
                                        <a href="{{ url('news/front/details/'.$video_news[1]->id) }}" class="slider-headline">
                                            <h3>{{$video_news[6]->title}}</h3>
                                        </a>
                                    </a>
                                </div>
                                <div class="single-video-slide">
                                    <a href="{{$video_news[2]->vedio_link}}" style="background-image: url({{ url('public/images/news/featured/'.$video_news[2]->featured_image) }})" class="video-play-btn long-height play-bg-3 mfp-iframe">
                                        <div class="video-icon-table">
                                            <div class="video-icon-tablecell">
                                                <i class="fa fa-play"></i>
                                            </div>
                                        </div>
                                        <a href="{{ url('news/front/details/'.$video_news[2]->id) }}" class="slider-headline">
                                            <h3>{{$video_news[2]->title}}</h3>
                                        </a>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="">
                            @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                <img ng-click="changeAd('Education', 85)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[4]->image_id)}}" alt="">
                            @else
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="cta-bar">
                            <h2>জাতীয় বিশ্ববিদ্যালয়</h2>
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">জাতীয় বিশ্ববিদ্যালয়</h3>
                        </div>
                        @if(count($national_university)>2)
                            <div class="big-section-slider">
                                <?php
                                $i=0;
                                ?>
                                @foreach($national_university as $index=>$news)
                                    @if($i<3)
                                        <?php $i++; ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="">
                            @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                <img ng-click="changeAd('Education', 86)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[5]->image_id)}}" alt="">
                            @else
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="cta-bar">
                            <h2>সরকারি বিশ্ববিদ্যালয়</h2>
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">সরকারি বিশ্ববিদ্যালয়</h3>
                        </div>
                        @if(count($govt_university)>2)
                            <div class="big-section-slider">
                                <?php
                                $i=0;
                                ?>
                                @foreach($govt_university as $index=>$news)
                                    @if($i<3)
                                        <?php $i++; ?>
                                        <div class="single-big-slider"  style="background-image: url({{ url('public/images/news/featured/'.$news->featured_image) }})">
                                            <a href="{{ url('news/front/details/'.$news->id) }}" class="slider-headline">
                                    ...
                                    <div class="single-thumbnail-item-3">
                                        ...
                                        <div class="news-content">
                                            <a href="{{ url('news/front/details/'.$all_news[30]->id) }}">
                                                ...
                                                <p><?php echo mb_substr(strip_tags($all_news[30]->details), 0, 297); ?></p>
                                            </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a href="">
                            @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                <img ng-click="changeAd('Education', 87)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[6]->image_id)}}" alt="">
                            @else
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="cta-bar">
                            <h2>বে-সরকারি বিশ্ববিদ্যালয়</h2>
                        </div>
                    </div>
                    <div class="col-sm-10">
                        <div class="cta-bar-alternative">
                            <h3 class="section-heading">বে-সরকারি বিশ্ববিদ্যালয়</h3>
                        </div>
                        @if(count($private_university)>2)
                            <div class="big-section-slider">
                                <?php
                                $i=0;
                                ?>
                                @foreach($private_university as $index=>$news)
                                    @if( $i<3)
                                        <?php $i++; ?>
                                        <div class="single-big-slider"  style="background-image: url({{ url('public/images/news/featured/'.$news->featured_image) }})">
                                            <a href="{{ url('news/front/details/'.$news->id) }}" class="slider-headline">
                            ...
                            <div class="single-thumbnail-item-1">
                                ...
                                <div class="news-content">
                                    <a href="{{ url('news/front/details/'.$all_news[31]->id) }}">
                                        ...
                                        <p><?php echo mb_substr(strip_tags($all_news[31]->details), 0, 297); ?></p>
                                    </a>
                                ...
                                <div class="single-thumbnail-item-1">
                                    ...
                                    <div class="news-content">
                                        <a href="{{ url('news/front/details/'.$all_news[32]->id) }}">
                                            ...
                                            <p><?php echo mb_substr(strip_tags($all_news[32]->details), 0, 297); ?></p>
                                        </a>
                                ...
                                <div class="single-thumbnail-item-2">
                                    ...
                                    <div class="news-content">
                                        <a href="{{ url('news/front/details/'.$all_news[33]->id) }}">
                                            ...
                                            <p><?php echo mb_substr(strip_tags($all_news[33]->details), 0, 297); ?></p>
                                        </a>
                                    ...
                                    <div class="single-thumbnail-item-2">
                                        ...
                                        <div class="news-content">
                                            <a href="{{ url('news/front/details/'.$all_news[34]->id) }}">
                                                ...
                                                <p><?php echo mb_substr(strip_tags($all_news[34]->details), 0, 297); ?></p>
                                            </a>
                                ...
                                <div class="single-thumbnail-item-2">
                                    ...
                                    <div class="news-content">
                                        <a href="{{ url('news/front/details/'.$all_news[35]->id) }}">
                                            ...
                                            <p><?php echo mb_substr(strip_tags($all_news[35]->details), 0, 297); ?></p>
                                        </a>
                                    ...
                                    <div class="single-thumbnail-item-2">
                                        ...
                                        <div class="news-content">
                                            <a href="{{ url('news/front/details/'.$all_news[36]->id) }}">
                                                ...
                                                <p><?php echo mb_substr(strip_tags($all_news[36]->details), 0, 297); ?></p>
                                            </a>
                                ...
                                <div class="single-thumbnail-item-2">
                                    ...
                                    <div class="news-content">
                                        <a href="{{ url('news/front/details/'.$all_news[37]->id) }}">
                                            <h3>{{$all_news[21]->title}}</h3>
                                            <p><?php echo mb_substr(strip_tags($all_news[37]->details), 0, 297); ?></p>
                                        </a>
                                    ...
                                    <div class="single-thumbnail-item-2">
                                        ...
                                        <div class="news-content">
                                            <a href="{{ url('news/front/details/'.$all_news[38]->id) }}">
                                                ...
                                                <p><?php echo mb_substr(strip_tags($all_news[38]->details), 0, 297); ?></p>
                                            </a>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="">
                                @if(isset(Auth::user()->id) && Auth::user()->role == 1)
                                    <img ng-click="changeAd('Education', 88)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[7]->image_id)}}" alt="">
                                @else
            ...
            <div class="section-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="cta-bar">
                                <h2>মাধ্যমিক ও <br> উচ্চ মাধ্যমিক</h2>
                            </div>
                        </div>

                        <div class="col-sm-10">
                            <div class="cta-bar-alternative">
                                <h3 class="section-heading">মাধ্যমিক ও <br> উচ্চ মাধ্যমিক</h3>
                            </div>
                            @if(count($ucchomaddhomik)>2)
                                <div class="big-section-slider">
                                    <?php
                                    $i=0;
                                    ?>
                                    @foreach($ucchomaddhomik as $index=>$news)
                                        @if($i<3)
                                            <?php $i++; ?>
                                            <div class="single-big-slider"  style="background-image: url({{ url('public/images/news/featured/'.$news->featured_image) }})">
                                                <a href="{{ url('news/front/details/'.$news->id) }}" class="slider-headline">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<a href="">
						@if(isset(Auth::user()->id) && Auth::user()->role == 1)
        <img ng-click="changeAd('Education', 8)" style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[5]->image_id)}}" alt="">
						@else
        <a href="{{ $ads[5]->external_link }}" target="_blank"><img style="cursor:pointer" src="{{asset('public/images/assets/'.$ads[5]->image_id)}}" alt=""></a>
						@endif
            </a>
...
-->
        ...
        <div class="section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="section-heading education"><a href="">পড়াশুনা</a></h3>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <h3 class="section-heading"><a href="">নিম্ন মাধ্যমিক</a></h3>
                        <div class="single-thumbnail-item-3">
                            <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$nimnomaddhomik[0]->featured_image)}})"></div>
                            <div class="news-content">
                                <a href="{{ url('news/front/details/'.$nimnomaddhomik[0]->id) }}">
                                    <h3>{{$nimnomaddhomik[0]->title}}</h3>
                                    <p><?php echo mb_substr(strip_tags($nimnomaddhomik[0]->details), 0, 297); ?></p>
                                </a>
                                <a href="{{ url('news/front/details/'.$nimnomaddhomik[0]->id) }}" class="news-readmore-btn">বিস্তারিত</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <h3 class="section-heading"><a href="">মাধ্যমিক</a></h3>
                        <div class="single-thumbnail-item-3">
                            <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$maddhomik[0]->featured_image)}})"></div>
                            <div class="news-content">
                                <a href="{{ url('news/front/details/'.$maddhomik[0]->id) }}">
                                    <h3>{{$maddhomik[0]->title}}</h3>
                                    <p><?php echo mb_substr(strip_tags($maddhomik[0]->details), 0, 297); ?></p>
                                </a>
                                <a href="{{ url('news/front/details/'.$maddhomik[0]->id) }}" class="news-readmore-btn">বিস্তারিত</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        ...
                        <div class="single-thumbnail-item-3">
                            <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$college[0]->featured_image)}})"></div>
                            <div class="news-content">
                                <a href="{{ url('news/front/details/'.$college[0]->id) }}">
                                    <h3>{{$college[0]->title}}</h3>
                                    <p><?php echo mb_substr(strip_tags($college[0]->details), 0, 297); ?></p>
                                </a>
                                <a href="{{ url('news/front/details/'.$college[0]->id) }}" class="news-readmore-btn">বিস্তারিত</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <br>
        <div class="container">
            <a href="{{url('category/education/more')}}" class="news-readmore-btn btn btn-primary">আরও খবর</a>
        </div>
        <br>
