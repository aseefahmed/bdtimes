                                    ...
                                    <div class="col-sm-9">
                                        <div class="col-sm-12">
                                            <div class="radio radio-custom radio-inline radio-primary">
                                                <input type="radio" id="flag_{{$news[0]->flag}}" name="flag" value="2" <?php if($news[0]->flag==0){echo "checked";} ?>>
                                                <label for="flag_{{$news[0]->flag}}">Draft</label>
                                            </div>
                                            <div class="radio radio-custom radio-inline radio-primary">
                                                <input type="radio" id="ln_publish" name="flag" value="0" <?php if($news[0]->flag==1){echo "checked";} ?>>
