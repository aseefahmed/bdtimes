...
@section('content')
    <form class="form-horizontal form-stripe" id="addNewsForm" action="addvideo" method="POST" enctype="multipart/form-data">
        <div class="row animated fadeInUp" ng-controller="NewsController">

            <input type="hidden" name="flag" id="flag">
            {{ csrf_field() }}
            <div class="col-sm-12 col-md-8">
                <h4 class="section-subtitle"><b>ADD</b>Video NEWS</h4>
                <div class="panel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select  class="form-control select2js" id="main_category" style="width: 100%" name="categories" id="categories" required>
                                            <option value="138">Choose Category</option>
                                ...
                                <div class="form-group" style="float:right; margin-right: 0%;">
                                    {{--<a class="form-control btn btn-success saveVideoPostBtn" >Publish</a>--}}
