    ...
    <div class="col-md-12 text-center">
      ...
      <table class="data-table table table-striped table-hover responsive nowrap responsive-table" cellspacing="0" width="100%">
        ...
        <tr> 
          ...
          <td class="text-right">
          	<a href="{{ url('view/profile/'.$user->id) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a> 
            @if(Auth::user()->role == 1) <a href="{{ url('edit/profile/'.$user->id) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> @endif 
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group form-group-default">
                    ...
                    <input type="email" class="form-control" ng-model="user.username" id="username" ng-required="true" name="username" ng-model-options="{updateOn: 'blur'}" ng-blur="checkEmail()">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group form-group-default">
