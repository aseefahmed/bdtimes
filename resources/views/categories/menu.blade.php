                    ...
                    <table class="table table-striped responsive-table" id="responsive-table">
                        ...
                        @foreach($menus as $key=>$cat)
                            <tr>
                                ...
                                <td class="text-right">
                                    <a href="{{ url('categories/status/'.$cat->id) }}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Status">Change Status<!--<i class="fa fa-pencil-square-o"></i>--></a>
