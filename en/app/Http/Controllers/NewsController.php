...
class NewsController extends Controller
{
	...
	public function viewFrontNews($id)
	{
		...
		$data['comments'] = DB::table('comments')->leftJoin('users', 'users.id', '=', 'comments.user_id')->where('comments.news_id', $id)->orderBy('comments.id', 'desc')->select('users.*', 'comments.id', 'comments.user_id', 'comments.details')->get();
