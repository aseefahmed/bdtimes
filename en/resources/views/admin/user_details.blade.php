...
@if(true)
  ...
  <div class="pull-left" style="padding-left:15px;">
    ...
    <div class="col-xs-12">
      ...
      <a href="{{ url('password/change/') }}" class="btn btn-wide btn-danger" >Change Password</a>
      <a href="{{ url('edit/profile/') }}" class="btn btn-wide btn-primary" >Edit Profile</a>
        ...
        <div class="p-info">
          ...
          <ul>
            ...
            <li> @if($user_type == 'clients') <span>Account Type</span> @if($user[0]->account_type == 1)
              ...
              @elseif($user_type == 'profile') <span>Role</span>
