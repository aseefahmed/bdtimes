                    ...
                    <div class="write-here tab-pane active fade in" role="tabpanel" id="write-here">
                        <div class="col-xs-12">
							...
							{{csrf_field()}}
                                ...
                                <input type="text" placeholder="Title" name="news_title">
                                <textarea  id="" cols="30" rows="10" placeholder="Write here" name="news_details"></textarea>
								Featured Image: <input type="file"  name="featured_image" placeholder="Picture">
                                <input type="submit" class="savePostBtn" flag="0" value="Save">
                                <input type="submit" class="savePostBtn" flag="1" value="Publish">
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="col-xs-12">
                            <table class="writings">
                                ...
                                @foreach($news_list as $news)
									<tr>
										<td class="big-td"><a href="{{url('news/front/details/'.$news->id)}}">{{$news->title}}</a></td>
                    ...
                    <div class="edit-profile tab-pane fade" role="tabpanel" id="edit-profile">
                        <div class="col-xs-4 text-center">
                            <div class="change-picture">
                                ...
                                <a href="" class="picture-change-btn">
                        ...
                        <div class="col-xs-8">
                            <div class="profile-input-form">
								...
								<input type="hidden" name="user_id" value="{{Auth::user()->id}}">
                                    <input type="text" class="first-name" name="first_name" placeholder="First name" value="{{Auth::user()->first_name}}">
                                    <input type="text" class="last-name" name="last_name" placeholder="Last name" value="{{Auth::user()->last_name}}">
                                    <input type="email" disabled placeholder="{{Auth::user()->email}}">
                                    <input type="file"  name="photo" placeholder="Picture">
                                    <input type="submit" value="Submit" id="edit_user">
                                </form>
                            </div>
                        </div>
                    </div>
