				...
				<div class="panel-content">
					<div class="row">
						<div class="col-md-12">
							  ...
							  <div class="form-group">
								  <label for="name" class="col-sm-3 control-label">News Sub Title</label>
								  <div class="col-sm-9">
								  {{ $news[0]->sub_title }}
								  </div>
							  </div>
							  ...
							  <div class="form-group">
								  <label for="name" class="col-sm-3 control-label">Keywords</label>
								  <div class="col-sm-9">
									<?php 
										$str = "";
							  ...
							  @if($news[0]->vedio_link  )
								  <div class="form-group">
									  <label for="password3" class="col-sm-3 control-label">Details</label>
									  <div class="col-sm-9">
										<?php 
											echo $news[0]->vedio_link;
										?>
									  </div>
								  </div>
							  @endif
