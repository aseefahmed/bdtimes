                        ...
                        <div class="single-page-news">
                            ...
                            <div class="report-info">
                            	@if($news_details[0]->image_caption != "")
                                	<p>{{$news_details[0]->image_caption}} <span> | Bangladesh Times file photo</span></p>
                                @endif
                            </div>
                            <h3>
						...
						<div class="col-xs-12">
                            <div class="row">
                                <div class="more-news-singlepage">
                                    <h3 class="section-heading"><a href="">More news from this section</a></h3>
                ...
                <div class="col-md-4">
                    <div class="right-content-section single-page">
                        ...
                        <div class="opinion-section margin-top-10">
							<h3 class="section-heading"><a href="">Public opinion survey</a></h3>
