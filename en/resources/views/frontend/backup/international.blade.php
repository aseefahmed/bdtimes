		...
		<div class="container">
			<div class="row">
				<div class="col-sm-7 col-sm-offset-2">
					<div class="cta-bar">
						<h2>{{Session::get('breaking_news')}}</h2>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-5 col-xs-12">
				<h3 class="section-heading"><a href="">{{Session::get('recent')}}</a></h3>
				@foreach($internation_recent as $news)
					<div class="single-thumbnail-item-1">
						...
						<div class="news-content">
							...
							<a href="{{ url('news/front/details/'.$news->id) }}" class="news-readmore-btn">{{Session::get('readmore')}} <i class="fa fa-arrow-right"></i></a>
						</div>
					</div>
				@endforeach
			</div>
			<div class="col-sm-7 col-xs-12">
				<h3 class="section-heading">{{Session::get('reporting')}}</h3>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-2">
				<div class="cta-bar">
					<h2>{{Session::get('middleast')}}</h2>
				</div>
				<div class="cta-bar-alternative">
					<h3 class="section-heading"><a href="">{{Session::get('middleast')}}</a></h3>
				</div>
...
<div class="section-padding">
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-2">
				<div class="cta-bar">
					<h2>{{Session::get('northamerica')}}</h2>
				</div>
				<div class="cta-bar-alternative">
					<h3 class="section-heading"><a href="">{{Session::get('recent')}}</a></h3>
				</div>
...
<div class="section-padding">
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-2">
				<div class="cta-bar">
					<h2>{{Session::get('europe')}}</h2>
				</div>
				<div class="cta-bar-alternative">
					<h3 class="section-heading"><a href="">ইউরোপ</a></h3>
				</div>
				<div class="big-section-slider">
					<?php $i=0; ?>
...
<div class="section-padding">
	<div class="container">
		<div class="row">
			<div class="col-sm-10 col-sm-offset-2">
				<div class="cta-bar">
					<h2>{{Session::get('asia')}}</h2>
				</div>
				<div class="cta-bar-alternative">
					<h3 class="section-heading"><a href="">এশিয়া</a></h3>
				</div>
				<div class="big-section-slider">
