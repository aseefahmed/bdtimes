							...
							<div class="single-thumbnail-item-2">
								<div class="news-content">
									<a href="{{ url('news/front/details/'.$probash_jibon[0]->id) }}">
										...
										<p><?php echo mb_substr(strip_tags($probash_jibon[0]->short_description), 0, 2050); ?></p>
									</a>
				...
				<div class="col-sm-6 col-xs-12">
					<div class="single-thumbnail-item-1">
						...
						<div class="news-content">
							...
							<p><?php echo mb_substr(strip_tags($probash_jibon[1]->short_description), 0, 550); ?></p>
				...
				<div class="col-sm-6 col-xs-12">
					<div class="single-thumbnail-item-1">
						...
						<div class="news-content">
							...
							<p><?php echo mb_substr(strip_tags($probash_jibon[2]->short_description), 0, 550); ?></p>
