            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-2">
                    ...
                    <div class="row">
                        ...
                        @foreach($video_reporting as $video)
                            <div class="col-sm-3">
                                <div class="single-video-item">
                                   <div class="vdo-heding-text">
                                    ...
                                    <a href="{{$video->vedio_link}}" class="service-video reporting-video-bg mfp-iframe">
                                        <div class="video-icon-table">
                                            <div class="video-icon-tablecell">
                                                <i class="fa fa-play"></i>
                                            </div>
    ...
    <div class="video-service-area section-padding">
        <div class="container">
            <div class="row">
                        ...
                        @foreach($video_programme as $video)
                            <div class="col-sm-3">
                                <div class="single-video-item">
                                   <div class="vdo-heding-text">
                                        <a href="single-page.html" class="single-video-heading">
    ...
    <div class="video-service-area section-padding">
        <div class="container">
            <div class="row">
                        ...
                        @foreach($video_boithokkhana as $video)
                            <div class="col-sm-3">
                                <div class="single-video-item">
                                   <div class="vdo-heding-text">
                                        <a href="single-page.html" class="single-video-heading">
    ...
    <div class="video-service-area section-padding">
        <div class="container">
            <div class="row">
                        ...
                        @foreach($video_itihash as $video)
                            <div class="col-sm-3">
                                <div class="single-video-item">
                                   <div class="vdo-heding-text">
                                        <a href="single-page.html" class="single-video-heading">
    ...
    <div class="video-service-area section-padding">
        <div class="container">
            <div class="row">
                        ...
                        @foreach($video_nrigoshthi as $video)
                            <div class="col-sm-3">
                                <div class="single-video-item">
                                   <div class="vdo-heding-text">
                                        <a href="single-page.html" class="single-video-heading">
