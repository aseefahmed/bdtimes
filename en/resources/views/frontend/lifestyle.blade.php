                ...
                <div class="col-sm-5 col-xs-12">
                    ...
                    <div class="single-thumbnail-item-1">
                        ...
                        <div class="news-content">
                            <h3>a video song in 50 days</h3>
                            <p>Generally a song need only few days to get finished</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Fashion</h3>
					</div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Roopchurch</h3>
					</div>
                    <div class="big-section-slider">
                        <div class="single-big-slider big-bg-1">
                            <a href="" class="slider-headline">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-12">
                    <div class="single-thumbnail-item-1">
                        ...
                        <div class="news-content">
                            <h3>a video song in 50 days</h3>
                            <p>Generally a song need only few days to get finished</p><a href="#" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Furnishing</h3>
					</div>
                    <div class="big-section-slider">
                        <div class="single-big-slider big-bg-1">
                            <a href="" class="slider-headline">
