...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-xs-12">
                    <h3 class="section-heading"><a href="">Teenager</a></h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">Paint puff</a></h3>
                    </div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">starting</a></h3>
                    </div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <div class="cta-bar-alternative">
                        <h3 class="section-heading"><a href="">Funny story</a></h3>
                    </div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h3 class="section-heading"><a href="">KIDS video</a></h3>
                ...
                <div class="col-sm-7 pdt-10">
                    <h3 class="section-heading"><a href="">Photo Gallery</a></h3>
