        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-xs-12">
                    <h3 class="section-heading"><a href="">Science and Technology</a></h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Apps</h3>
					</div>
                    <div class="row">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Science</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">E-commerce</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Outsourcing</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Job</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Software training</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
				<div class="col-sm-2">
				    <div class="cta-bar">
				        <h2>Mobile installment</h2>
				    </div>
				</div>
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Mobile installment</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
				<div class="col-sm-2">
				    <div class="cta-bar">
				        <h2>Awareness fundamental video</h2>
				    </div>
				</div>
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Awareness fundamental video</h3>
					</div>
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
