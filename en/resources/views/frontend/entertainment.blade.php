		...
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="cta-bar-alternative">
				    <h3 class="section-heading">Small screen</h3>
				</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-10">
				<div class="cta-bar-alternative">
				    <h3 class="section-heading">Dhaliud</h3>
				</div>
			...
			<div class="col-md-4 col-sm-6">
				...
				<div class="custom-tab readers-qs">
					<ul class="tab-list text-center">
						...
						<li><a data-toggle="tab" href="#custom-tab-2">Hindi</a></li>
						<li><a data-toggle="tab" href="#custom-tab-3">Hindi</a></li>
					</ul>
				...
				@if(isset($all_news[30]))
								<div class="single-thumbnail-item-2 min-h75">
					                ...
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[30]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
								</div>
				@endif
							</div>
				...
				@if(isset($all_news[31]))
								<div class="single-thumbnail-item-2">
					                ...
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[31]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
								</div>
				@endif
			...
			<div class="col-sm-4 col-xs-12">
				<div class="single-thumbnail-item-3">
	                ...
	                <div class="news-content">
		                ...
		                <a href="{{ url('news/front/details/'.$all_news[35]->id) }}" class="news-readmore-btn">Details</a>
	                </div>
				</div>
			</div>
				@endif
...
<div class="section-padding">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="cta-bar-alternative">
				    <h3 class="section-heading">Bollywood</h3>
				</div>
				<div class="big-section-slider">
				<?php
					$i=0;
				...
				<div class="single-thumbnail-item-2">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[41]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[41]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-2">
				    <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[42]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[42]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
			</div>
				...
				<div class="single-thumbnail-item-2">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[43]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[43]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-2">
					...
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[44]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[44]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
			</div>
				...
				<div class="single-thumbnail-item-2">
				    <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[45]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[45]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-2">
				    <div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[46]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[46]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
			</div>
...
<div class="section-padding">
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-10">
				<div class="cta-bar-alternative">
				    <h3 class="section-heading">Hollywood</h3>
				</div>
				<div class="big-section-slider">
					<?php
					$i=0;
				...
				<div class="single-thumbnail-item-3">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[47]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[47]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
			</div>
				@endif
				...
				<div class="single-thumbnail-item-3">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[48]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[48]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
			</div>
				@endif
					...
					<div class="news-img">
						<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[49]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[49]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
			</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[50]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[50]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[51]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[51]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
			</div>
				...
				<div class="single-thumbnail-item-1">
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[52]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[52]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					...
					<div class="thumbnail-bg" style="background-image: url({{asset('public/images/news/featured/'.$all_news[53]->featured_image)}})"></div>
					                <div class="news-content">
						                ...
						                <a href="{{ url('news/front/details/'.$all_news[53]->id) }}" class="news-readmore-btn">Details</a>
					                </div>
				</div>
				@endif
			</div>
			...
			<div class="col-sm-4">
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[54]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i></a>
					</div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[55]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i></a>
					</div>
				</div>
				@endif
			</div>
			<div class="col-sm-4">
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[56]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i><>
					</div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[57]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i></a>
					</div>
				</div>
				@endif
			</div>
			<div class="col-sm-4">
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[58]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i><a>
					</div>
				</div>
				@endif
				...
				<div class="single-thumbnail-item-1">
					<div class="news-content">
						...
						<a href="{{ url('news/front/details/'.$all_news[59]->id) }}" class="news-readmore-btn">Details<i class="fa fa-arrow-right"></i><
						</div>
				</div>
				@endif
			</div>
