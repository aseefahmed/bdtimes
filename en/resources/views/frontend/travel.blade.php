        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-5 col-xs-12">
                    <h3 class="section-heading"><a href="">Travel</a></h3>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
				<div class="col-sm-2">
				    <div class="cta-bar">
				        <h2>Spectacular Place</h2>
				    </div>
				</div>
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Spectacular Place</h3>
					</div>
					<div class="big-section-slider">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Time index</h3>
					</div>
                    <div class="custom-tab readers-qs">
                        <ul class="tab-list text-center">
                            <li class="active"><a data-toggle="tab" href="#custom-tab-1">Bus</a></li>
                            <li><a data-toggle="tab" href="#custom-tab-2">Train</a></li>
                            <li><a data-toggle="tab" href="#custom-tab-3">Aircraft</a></li>
                            <li><a data-toggle="tab" href="#custom-tab-3">Launch</a></li>
                        </ul>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Where-how</h3>
					</div>
                    <div class="big-section-slider">
						...
						@if($index>2 && $index<5)
							 <div class="single-thumbnail-item-3">
								...
								<div class="news-content">
										<a href="{{ url('news/front/details/'.$news->id) }}">
										<h3>{{$news->title}}</h3>
										<p><?php echo mb_substr(strip_tags($all_news[36]->details), 0, 550); ?></p>
										</a>
										<a href="{{ url('news/front/details/'.$news->id) }}" class="news-readmore-btn">Details</a>
								</div>
							</div>
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-10">
					<div class="cta-bar-alternative">
					    <h3 class="section-heading">Experience travel</h3>
					</div>
                    <div class="big-section-slider">
