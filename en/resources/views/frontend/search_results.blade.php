                ...
                <div class="col-md-4">
                    <div class="right-content-section single-page">
                        <div class="calender homepage">
                            <h3 class="section-heading">Archives</h3>
								...
								<p>
									<form id="myVoteForm" method="post">
									   {{ csrf_field() }}
										...
										<input type="radio" class="myvote" value="nocomment" name="myvote" selected>&nbsp;No Comments<br>
										<input type="submit" id="vote_btn" class="btn btn-warning" value="Give Vote" >&nbsp;
										<a class="fb-signup" href="{{url('/votes/result')}}">Old Result</a>
									</form>
								</p>
							</div>
                        </div>
