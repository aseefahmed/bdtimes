...
class UserController extends Controller
{
    ...
    public function viewUserDetails($user_type, $id=null)
    {
		if($id == null)
		{
			$id = Auth::user()->id;
		}
        echo $data['user_type'] = $user_type;
    ...
    public function updateUser(Request $request)
    {
		...
		if($request->photo){
            ...
            $request->file('photo')->move('public/images/profiles', $file_name);
		...
		if($request->password != "")
			$user = DB::table('users')->where('id', $request->user_id)->update(['password' => Hash::make($request->password)]);
    }
    ...
    public function editUserDetails($user_type, $id=null)
    {
		if($id == null)
		{
			$id = Auth::user()->id;
