...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('news/addvideo', ['as' => 'news', 'uses' => 'NewsController@addVideoNews']);
    Route::get('news/addpicture', ['as' => 'news', 'uses' => 'NewsController@addPictureNews']);
...
//    Route::post('news/addvideo/{user_type?}', ['as' => 'news', 'uses' => 'NewsController@submitVideoNews']);
    Route::post('news/addvideo', ['as' => 'news', 'uses' => 'NewsController@submitVideoNews']);
    Route::post('news/addpicture', ['as' => 'news', 'uses' => 'NewsController@submitPictureNews']);
    ...
    Route::post('status/edit/{id}', ['as' => 'news', 'uses' => 'CategoriesController@editStatusSubmit']);
    Route::get('categories/edit/{id}', ['as' => 'news', 'uses' => 'CategoriesController@editCat']);
    Route::get('categories/status/{id}', ['as' => 'news', 'uses' => 'CategoriesController@editStatus']);
    Route::get('category/searchSubCategory/{parent_category}', ['as' => 'news', 'uses' => 'CategoriesController@seachSubCategory']);

    Route::get('division/searchdistrict/{parent_division}', ['as' => 'news', 'uses' => 'CategoriesController@searchdistrict']);

    Route::get('division/searchdistrictforancolik/{parent_division}', ['as' => 'news', 'uses' => 'CategoriesController@searchdistrictforancolik']);
    Route::get('division/district/searchupazila/{parent_district}', ['as' => 'news', 'uses' => 'CategoriesController@searchupazila']);

    Route::get('division/district/searchupazilasforancolik/{parent_district}', ['as' => 'news', 'uses' => 'CategoriesController@searchupazilasforancolik']);

    Route::get('division/getdivision', ['as' => 'news', 'uses' => 'CategoriesController@getdivision']);

    //Route::post('news/searchAncolik', ['as' => 'news', 'uses' => 'NewsController@searchAncolikNews']);
    ...
    Route::get('categories/menu', ['as' => 'Menus', 'uses' => 'CategoriesController@menu']);
	...
	Route::get('category/national/more', ['as' => 'morenational', 'uses' => 'CategoriesController@getMoreNationalPage']);

    Route::get('category/ancolik', ['as' => 'ancolik', 'uses' => 'CategoriesController@getAncolikPage']);
    Route::post('category/ancolik', ['as' => 'ancolik', 'uses' => 'NewsController@searchAncolikNews']);


    Route::get('category/international', ['as' => 'international', 'uses' => 'CategoriesController@getInternationalPage']);
    Route::get('category/international/more', ['as' => 'moreinternational', 'uses' => 'CategoriesController@getMoreInternationalPage']);
    Route::get('category/economics', ['as' => 'economics', 'uses' => 'CategoriesController@getEconomicsPage']);
    Route::get('category/economics/more', ['as' => 'moreeconomics', 'uses' => 'CategoriesController@getMoreEconomicsPage']);
    Route::get('category/entertainment', ['as' => 'entertainment', 'uses' => 'CategoriesController@getEntertainmentPage']);

    Route::get('category/jobs', ['as' => 'jobs', 'uses' => 'CategoriesController@getJobsPage']);
    Route::get('category/viral', ['as' => 'viral', 'uses' => 'CategoriesController@getViralPage']);

    Route::get('category/entertainment/more', ['as' => 'moreentertainment', 'uses' => 'CategoriesController@getMoreEntertainmentPage']);
    Route::get('category/education', ['as' => 'education', 'uses' => 'CategoriesController@getEducationPage']);
    Route::get('category/education/more', ['as' => 'moreeducation', 'uses' => 'CategoriesController@getMoreEducationPage']);
    Route::get('category/sports', ['as' => 'sports', 'uses' => 'CategoriesController@getSportsPage']);
    Route::get('category/sports/more', ['as' => 'moresports', 'uses' => 'CategoriesController@getMoreSportsPage']);
    Route::get('category/science', ['as' => 'science', 'uses' => 'CategoriesController@getSciencePage']);
    Route::get('category/science/more', ['as' => 'more science', 'uses' => 'CategoriesController@getMoreSciencePage']);
    Route::get('category/crime', ['as' => 'crime', 'uses' => 'CategoriesController@getCrimePage']);
    Route::get('category/crime/more', ['as' => 'more crime', 'uses' => 'CategoriesController@getMoreCrimePage']);

    Route::get('category/buysell', ['as' => 'sell', 'uses' => 'CategoriesController@getBuyAndSellPage']);

    Route::get('category/youth', ['as' => 'youth', 'uses' => 'CategoriesController@getYouthPage']);

    Route::get('category/health', ['as' => 'health', 'uses' => 'CategoriesController@getHealthPage']);
    Route::get('category/health/more', ['as' => 'more health', 'uses' => 'CategoriesController@getMoreHealthPage']);

    Route::get('category/travel', ['as' => 'travel', 'uses' => 'CategoriesController@getTravelPage']);
    Route::get('category/travel/more', ['as' => 'more travel', 'uses' => 'CategoriesController@getMoreTravelPage']);

    Route::get('category/kids', ['as' => 'kids', 'uses' => 'CategoriesController@getKidsPage']);
    Route::get('category/kids/more', ['as' => 'more kids', 'uses' => 'CategoriesController@getMoreKidsPage']);

    Route::get('category/legal-aids', ['as' => 'legal-aids', 'uses' => 'CategoriesController@getLegalPage']);
    Route::get('category/legal-aids/more', ['as' => 'more legal-aids', 'uses' => 'CategoriesController@getMoreLegalPage']);

    Route::get('category/lifestyle', ['as' => 'lifestyle', 'uses' => 'CategoriesController@getLifestylesPage']);
    Route::get('category/lifestyle/more', ['as' => 'more lifestyle', 'uses' => 'CategoriesController@getMoreLifestylesPage']);

    Route::get('category/kids', ['as' => 'kids', 'uses' => 'CategoriesController@getkidsPage']);
    Route::get('category/politics', ['as' => 'politics', 'uses' => 'CategoriesController@getPoliticsPage']);

    Route::get('category/culture', ['as' => 'culture', 'uses' => 'CategoriesController@getCulturePage']);
    Route::get('category/culture/more', ['as' => 'more culture', 'uses' => 'CategoriesController@getMoreCulturePage']);



    Route::get('category/politics/more', ['as' => 'morepolitics', 'uses' => 'CategoriesController@getMorePoliticsPage']);
    ...
    Route::get('category/women/more', ['as' => 'more women', 'uses' => 'CategoriesController@getMoreWomenPage']);
    Route::get('category/vedios', ['as' => 'vedios', 'uses' => 'CategoriesController@getVediosPage']);
    Route::get('category/photos', ['as' => 'photos', 'uses' => 'CategoriesController@getphotosPage']);

    Route::get('category/cartoon', ['as' => 'cartoon', 'uses' => 'CategoriesController@getCartoonPage']);

    Route::get('category/probash', ['as' => 'probash', 'uses' => 'CategoriesController@getProbashPage']);
    Route::get('category/probash/more', ['as' => 'more probash', 'uses' => 'CategoriesController@getMoreProbashPage']);
    Route::get('category/nreegoshthi', ['as' => 'nreegoshthi', 'uses' => 'CategoriesController@getNreegoshthiPage']);
    Route::get('category/history', ['as' => 'history', 'uses' => 'CategoriesController@getHistoryPage']);
    Route::get('category/history/more', ['as' => 'more history', 'uses' => 'CategoriesController@getMoreHistoryPage']);

    Route::get('category/rashi', ['as' => 'rashi', 'uses' => 'CategoriesController@getRashiPage']);

    Route::get('category/uthan-boithok', ['as' => 'uthan-boithok', 'uses' => 'CategoriesController@getUthanBoithokPage']);
    Route::get('category/uthan-boithok/more', ['as' => 'more uthan-boithok', 'uses' => 'CategoriesController@getMoreUthanBoithokPage']);
